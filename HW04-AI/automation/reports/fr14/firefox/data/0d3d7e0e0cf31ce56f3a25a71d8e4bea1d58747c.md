...
- Name: fr14-category-management.spec.js >> FR-14 Category management >> FR14-AUTO-009 Category text is rendered safely >> FR14-AUTO-009-01 Image-onerror payload
  ...
  - generic [ref=e15]:
    ...
    - table [ref=e20]:
      ...
      - rowgroup [ref=e26]:
        - row [ref=e27]:
          - cell "#801" [ref=e28]
          - cell "<img src=x onerror=alert(1)>" [ref=e29]
          - cell [ref=e30]:
